...
echoheader("Offer","Vip ویژه");
 ...
 $query_plantime = $db->query("SELECT * FROM ".PREFIX."_vip_gorup order by id asc");		
	...
	<table width="100%" cellpadding="0" cellspacing="0">
		...
		<tr>
        	<td height="25"> مدت پلان :</td>
            <td> <input type="text" name="plantime" value="$option_plnt" /> ماه</td>
        </tr>
        <tr><td>هرماه 30 روز حساب میشود</td></tr>
	</table>
...
<tr>
        	<td height="25"> مدت پلان :</td>
            <td> <input type="text" name="plantime" value="$option_plnt"/></td>
        </tr>
	</table>
...
HTML;
 ...
 //$db->query( "DELETE FROM " . PREFIX . "_vip_jahanpay WHERE `show`='1'" );
